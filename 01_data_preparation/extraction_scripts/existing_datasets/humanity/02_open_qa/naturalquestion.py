...
Default:
- question (English): "Question: {query}"
- answer: {answer}
- id: generated as {id_prefix}{start_id + i}

Run:
  python convert_query_answer_to_training.py --input input.jsonl --output output.jsonl

Example (your uploaded file path):
  python convert_query_answer_to_training.py \
    --input /mnt/data/01fbbaf1-f817-488b-9538-4528cadade1c.jsonl \
    --output output_dataset5.jsonl
"""
...
def main():
    parser = argparse.ArgumentParser(description="Convert JSONL (query/answer) to {id, question, answer} JSONL.")
    parser.add_argument("--input", required=True, help="Input JSONL path")
    parser.add_argument("--output", required=True, help="Output JSONL path")

    # English default template for this dataset
    parser.add_argument(
        "--question-template",
        default="Question: {query}",
        help="Question template (English). Use {query} placeholders."
    )
