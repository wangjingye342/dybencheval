...
# 生成数量
num_prompts = 40
target_scenarios = ["SocialScience"]
target_tasks = ["Code_Generation"]
...
TASK_PROBS = {
    "Basic_NLP": {"Open_QA": 0.18, "Writing": 0.18, "Reasoning": 0.17, "Role_Play": 0.17, "Professional_Knowledge": 0.16, "Code_Generation": 0.14},
    "Open_QA": {"Basic_NLP": 0.18, "Writing": 0.17, "Reasoning": 0.18, "Role_Play": 0.16, "Professional_Knowledge": 0.17, "Code_Generation": 0.13},
    "Writing": {"Basic_NLP": 0.19, "Open_QA": 0.18, "Reasoning": 0.17, "Role_Play": 0.17, "Professional_Knowledge": 0.16, "Code_Generation": 0.13},
    "Reasoning": {"Basic_NLP": 0.17, "Open_QA": 0.19, "Writing": 0.16, "Role_Play": 0.16, "Professional_Knowledge": 0.18, "Code_Generation": 0.14},
    "Role_Play": {"Basic_NLP": 0.18, "Open_QA": 0.17, "Writing": 0.17, "Reasoning": 0.17, "Professional_Knowledge": 0.16, "Code_Generation": 0.15},
    "Professional_Knowledge": {"Basic_NLP": 0.17, "Open_QA": 0.18, "Writing": 0.16, "Reasoning": 0.19, "Role_Play": 0.16, "Code_Generation": 0.14},
    "Code_Generation": {"Basic_NLP": 0.17, "Open_QA": 0.16, "Writing": 0.16, "Reasoning": 0.17, "Role_Play": 0.17, "Professional_Knowledge": 0.17}
}
...
def generate_prompt_content(loader, target_scenario, target_task):
    ...
    s4 = loader.get_random_sample_raw(target_scenario, style_t1)
    s5 = loader.get_random_sample_raw(target_scenario, style_t2)
    return PROMPT_TEMPLATE.format(
        ...
        shot3_content=s3,
        shot4_task_disp=TASK_DISPLAY[style_t1],
        shot4_content=s4,
        shot5_task_disp=TASK_DISPLAY[style_t2],
        shot5_content=s5
    )
...
def main():
    ...
    output_file = f"prompts/generated_prompts_{target_scenarios[0]}_{target_tasks[0]}.jsonl"
    count = 0
        ...
        for s in target_scenarios:
            for t in target_tasks:
                for _ in range(num_prompts):
                    ...
                    f.write(json.dumps({"target_scenario": s, "target_task": t, "prompt": prompt}, ensure_ascii=False) + "\n")
                    count += 1
